...
|---|---|---|
| **Order is the user's own, always.** Client-side, no accounts, no sync. New templates sort most-recent-first. | `02` amendment 2026-08-06, `schema-draft` | Any sort-mode control. Any server-supplied ordering. |
