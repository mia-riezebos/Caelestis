...
describe('theme tokens', () => {
  ...
  it('applies only the host values it receives', () => {
    ...
    expect(root.style.getPropertyValue('--caelestis-radius')).toBe('1rem')
