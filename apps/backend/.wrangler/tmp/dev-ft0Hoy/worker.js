...
// src/adapters/cloudflare/d1-sql-store.ts
var APPEND_BUCKET = `
...
`;
var fromRow = /* @__PURE__ */ __name((row) => ({
...
var D1SqlStore = class {
  constructor(database) {
    this.database = database;
  }
  database;
  static {
    __name(this, "D1SqlStore");
  }
  ...
  async readBuckets(query) {
    ...
    `);
    const result = await statement.bind(query.resolution, query.fromSeconds, query.toSeconds, ...query.templateIds).all();
    return result.results.map(fromRow);
  }
};

// src/adapters/cloudflare/do-counter-store.ts
var SINGLE_SHARD_NAME = "telemetry";
var DurableObjectCounterStore = class {
  static {
    __name(this, "DurableObjectCounterStore");
  }
  shard;
  ...
  async readPending(templateIds) {
    return this.shard.readPending(templateIds);
  }
};

// src/adapters/cloudflare/r2-blob-store.ts
var objectKey = /* @__PURE__ */ __name((namespace, hash) => `${namespace}/${hash}`, "objectKey");
var R2BlobStore = class {
  constructor(bucket) {
    this.bucket = bucket;
  }
  bucket;
  static {
    __name(this, "R2BlobStore");
  }
  async put(namespace, hash, bytes) {
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/compose.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/request/constants.js
var GET_MATCH_RESULT = /* @__PURE__ */ Symbol();

// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/utils/buffer.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/utils/body.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/request.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/utils/html.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/context.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/utils/constants.js
var COMPOSED_HANDLER = "__COMPOSED_HANDLER";

// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/hono-base.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router/reg-exp-router/node.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  static {
    __name(this, "Trie");
  }
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router/smart-router/router.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router/trie-router/node.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/router/trie-router/router.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/hono.js
...
// ../../node_modules/.pnpm/hono@4.12.33/node_modules/hono/dist/middleware/cors/index.js
...
// src/app.ts
var createApp = /* @__PURE__ */ __name((_ports) => {
  const app = new Hono2();
  app.use("/*", cors());
...
// src/telemetry-shard.ts
import { DurableObject } from "cloudflare:workers";
var RESOLUTION_SECONDS = 60;
var ALARM_DELAY_MILLISECONDS = 6e4;
var hasActivity = /* @__PURE__ */ __name(({ placed, correct, repairs }) => placed !== 0 || correct !== 0 || repairs !== 0, "hasActivity");
var TelemetryShard = class extends DurableObject {
  static {
    __name(this, "TelemetryShard");
  }
  constructor(ctx, env) {
    super(ctx, env);
  ...
  async readPending(templateIds) {
    ...
    const counters = this.ctx.storage.sql.exec(
      `
          SELECT
            template_id,
...
// ../../node_modules/.pnpm/wrangler@4.118.0_@cloudflare+workers-types@5.20260801.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@4.118.0_@cloudflare+workers-types@5.20260801.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-fpZgMc/middleware-loader.entry.ts
