-- MariaDB baseline equivalent to the SQLite schema through 0020.
-- Run with ANSI_QUOTES and PIPES_AS_CONCAT; binary collation preserves case-sensitive identifiers.

CREATE TABLE "access_tokens" (
	"token_hash" varchar(256) PRIMARY KEY NOT NULL,
	"label" longtext NOT NULL,
	"scope" longtext NOT NULL,
	"created_with_token" longtext NOT NULL,
...
CREATE TABLE "applied_events" (
	...
	"seen_at_ms" bigint NOT NULL, "accounting_json" longtext,
...
CREATE TABLE "canvas_tiles" (
	...
	CONSTRAINT "canvas_tiles_sha256_check" CHECK(("canvas_tiles"."sha256" IS NOT NULL) AND length("canvas_tiles"."sha256") = 64
        AND "canvas_tiles"."sha256" NOT REGEXP '[^0-9a-f]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_nopad_bin;
...
CREATE TABLE "contributions" (
	...
	"reported_with_token" longtext NOT NULL,
	...
	CONSTRAINT "contributions_reported_with_token_check" CHECK(("contributions"."reported_with_token" IS NOT NULL) AND length("contributions"."reported_with_token") = 64
        AND "contributions"."reported_with_token" NOT REGEXP '[^0-9a-f]'),
...
CREATE TABLE "nodes" (
	...
	"season" bigint NOT NULL,
	"surface_kind" varchar(256) DEFAULT 'world' NOT NULL,
	"alliance_id" bigint,
	"parent_id" varchar(256),
	"path" varchar(256) NOT NULL,
	"name" longtext NOT NULL,
	"description" longtext,
	"delete_token" longtext,
	"created_at_ms" bigint NOT NULL,
	...
	CONSTRAINT "nodes_path_check" CHECK("nodes"."path" REGEXP '^/' AND "nodes"."path" NOT REGEXP '[%_]'
        AND "nodes"."path" NOT REGEXP '/$' AND "nodes"."path" NOT REGEXP '//'
...
CREATE TABLE "status_read_model_revisions" (
	...
	"public_fingerprint" longtext NOT NULL,
	"admin_fingerprint" longtext NOT NULL,
	...
	CONSTRAINT "status_read_model_revisions_values_check" CHECK(("status_read_model_revisions"."season" IS NOT NULL) AND "status_read_model_revisions"."season" >= 0
        ...
        AND "status_read_model_revisions"."public_fingerprint" NOT REGEXP '[^0-9a-f]'
        AND length("status_read_model_revisions"."admin_fingerprint") = 64
        AND "status_read_model_revisions"."admin_fingerprint" NOT REGEXP '[^0-9a-f]'
...
CREATE TABLE "template_alarm_states" (
	"template_id" varchar(256) PRIMARY KEY NOT NULL,
...
CREATE TABLE "template_alarm_tile_statuses" (
	...
	"colours_json" longtext NOT NULL,
...
CREATE TABLE "template_versions" (
	...
	CONSTRAINT "template_versions_created_with_token_check" CHECK(("template_versions"."created_with_token" IS NOT NULL) AND length("template_versions"."created_with_token") = 64
        AND "template_versions"."created_with_token" NOT REGEXP '[^0-9a-f]'
...
CREATE TABLE "templates" (
	...
	CONSTRAINT "templates_created_with_token_check" CHECK(("templates"."created_with_token" IS NOT NULL) AND length("templates"."created_with_token") = 64
        AND "templates"."created_with_token" NOT REGEXP '[^0-9a-f]'
...
CREATE TABLE "tile_blob_objects" (
	"blob_key" varchar(256) PRIMARY KEY NOT NULL,
	"sha256" varchar(256) NOT NULL,
	...
	CONSTRAINT "tile_blob_objects_sha256_check" CHECK(("tile_blob_objects"."sha256" IS NOT NULL) AND length("tile_blob_objects"."sha256") = 64
        AND "tile_blob_objects"."sha256" NOT REGEXP '[^0-9a-f]'),
...
CREATE TABLE "tile_blob_reservations" (
	...
	CONSTRAINT "tile_blob_reservations_sha256_check" CHECK(("tile_blob_reservations"."sha256" IS NOT NULL) AND length("tile_blob_reservations"."sha256") = 64
        AND "tile_blob_reservations"."sha256" NOT REGEXP '[^0-9a-f]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_nopad_bin;
...
CREATE TABLE "tile_history" (
	...
	CONSTRAINT "tile_history_sha256_check" CHECK(("tile_history"."sha256" IS NOT NULL) AND length("tile_history"."sha256") = 64
        AND "tile_history"."sha256" NOT REGEXP '[^0-9a-f]'),
	CONSTRAINT "tile_history_reported_with_token_check" CHECK(("tile_history"."reported_with_token" IS NOT NULL) AND length("tile_history"."reported_with_token") = 64
        AND "tile_history"."reported_with_token" NOT REGEXP '[^0-9a-f]'),
...
CREATE TABLE "version_tiles" (
	...
	CONSTRAINT "version_tiles_hash_check" CHECK(("version_tiles"."hash" IS NOT NULL) AND length("version_tiles"."hash") = 64
        AND "version_tiles"."hash" NOT REGEXP '[^0-9a-f]'),
...
ALTER TABLE "nodes" ADD COLUMN "scope_alliance" bigint GENERATED ALWAYS AS (COALESCE("alliance_id", 0)) STORED;
ALTER TABLE "nodes" ADD COLUMN "path_key" varchar(256) GENERATED ALWAYS AS (lower("path")) STORED;
CREATE UNIQUE INDEX "nodes_surface_path_idx" ON "nodes" ("season", "surface_kind", "scope_alliance", "path_key");
...
INSERT INTO painter_bucket_collection (id, since_s) VALUES (1, UNIX_TIMESTAMP());
