...
CREATE TABLE `__saved_template_tile_statuses_0006` AS SELECT
...
INSERT INTO `template_tile_statuses` (
	...
	`template_id`, `version_id`, `tile_x`, `tile_y`, `correct`, `wrong`, `blank`,
	`colours_json`, `observed_at_ms`
FROM `__saved_template_tile_statuses_0006`;--> statement-breakpoint
DROP TABLE `__saved_template_tile_statuses_0006`;--> statement-breakpoint
