/** Marker limits offered to the user, per marker kind across the visible viewport. */
...
/** Refuse arbitrary persisted values so a corrupt setting cannot submit millions of GPU points. */
