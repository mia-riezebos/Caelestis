...
import { localTemplates, setAppearance, setLocalVisible } from '../templates/local-store.js'
...
const buildMenu = (
  ...
  move.appendChild(icon('rename', 'size-4'))
  ...
  header.append(title, hide, move, close)
