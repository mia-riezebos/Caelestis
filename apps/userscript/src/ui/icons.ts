...
const PATHS: Record<IconName, string> = {
  ...
  // Three stacked dots — "more actions on this specific thing", and exactly what wplace puts on
  // each row of their own Overlays list. A gear would claim these are settings; they are a menu.
  kebab:
  ...
  // Shown / hidden, for the colour swatches. The slash is drawn as part of the path rather than as
  // a separate stroke, so it scales with the glyph instead of needing its own geometry.
