 ...
 * like it covers the template. A marker is the opposite: it is an annotation about a pixel, and
 * covering it with the pixel it describes means the only way to watch a marker clear is to zoom out
