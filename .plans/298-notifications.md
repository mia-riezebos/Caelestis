...
## Acceptance criteria
- [ ] Desktop delivery and its userscript grant are removed.
- [ ] Hidden pages and painting use badge-only alarm behavior.
...
## TODOs
- [ ] Remove desktop delivery and validate existing alarm behavior.
