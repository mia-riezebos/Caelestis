...
- Docker Hub's `caelestis` namespace already exists and contains public php/rabbitmq/postgres repositories. The publishing namespace is awaiting Mia's choice; registry configuration remains unchanged pending that choice.
