...
- [ ] Capture, occupancy, notifications, and GPU uploads have attributable counters; sampling and unsupported signals are explicit.
...
- [~] Add capture, occupancy, notification, and GPU upload attribution with focused tests.
